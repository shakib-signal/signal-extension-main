...
//     (acc, cartLine) => {
//       // -------------------------------
//       // Skip subscription lines
//       // -------------------------------
//       const experiment = JSON.parse(cartLine.attribute?.value || '{}')
//       if (experiment?.selling_plan) {
//         return acc
//       }
...
//             price: {
//               adjustment: {
//                 fixedPricePerUnit: { amount: customPrice }
//               }
//             },
//             attributes: Object.entries(experiment).map(([key, value]) => ({
//               key,
