...
const customImageSelectors = {
  ...
  productCardImage: Array.isArray(product_card_image_selectors)
    ? product_card_image_selectors
    : [product_card_image_selectors],
  ...
  singleProductImage: Array.isArray(single_product_image_selectors)
    ? single_product_image_selectors
    : [single_product_image_selectors],

  predictiveSearchItem: Array.isArray(predictive_search_item_selectors)
    ? predictive_search_item_selectors
    : [predictive_search_item_selectors],

  predictiveSearchImage: Array.isArray(predictive_search_image_selectors)
    ? predictive_search_image_selectors
    : [predictive_search_image_selectors]
}
    ...
    sortedProducts.forEach((product) => {
      ...
      document
        ...
        .forEach((anchor) => {
          ...
          // Store the variant ID in the product link
          if (anchor.tagName === 'A') {
            const currentHref = new URL(anchor.href)
